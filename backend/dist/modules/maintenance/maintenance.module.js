...
exports.MaintenanceModule = MaintenanceModule = __decorate([
    (0, common_1.Module)({ controllers: [maintenance_controller_1.MaintenanceController], providers: [maintenance_service_1.MaintenanceService, database_service_1.DatabaseService] })
], MaintenanceModule);
